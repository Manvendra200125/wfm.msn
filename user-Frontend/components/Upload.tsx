  ...
  async function makePayment() {
    const transaction = new Transaction().add(
      SystemProgram.transfer({
        ...
        toPubkey: new PublicKey("6nUJy3hEs3z2EtLKbi7cyetFd6zrbTEuzCt15Bk4fvgF"),
        lamports: 100000000,
      })
    );
  ...
  return (
    <div className=" flex justify-center">
      <div className="max-w-screen-lg w-full">
        <div className="text-5xl text-center pt-20 w-full pl-4 text-black-500 justify-center ">
          Create A Task
        </div>

        <label className="pl-4 block mt-2 text-2xl font-large text-black-500">
          Task Details
        </label>
        ...
        <input
          ...
          type="text"
          id="first_name"
          className="ml-4 mt-1 bg-gray-50 border border-gray-300 text-black-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
          placeholder="What is your task?"
          required
        />

        <label className="pl-4 block mt-4 justify-center text-md text-2xl text-gray-900 ">
          Add Images
        </label>
