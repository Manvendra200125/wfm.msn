...
const connection = new Connection("https://solana-devnet.g.alchemy.com/v2/L4v2_e0ez21uU-WOZoBW9G0jSE02Kf0H");
...
router.post("/payout", workerMiddleware, async (req, res) => {
  ...
  const transaction = new Transaction().add(
    SystemProgram.transfer({
      fromPubkey: new PublicKey("6nUJy3hEs3z2EtLKbi7cyetFd6zrbTEuzCt15Bk4fvgF"),
